...
#### Solutions:
  ...
  - Linear Estimation
    ...
    - Reduce the number of parameters
      ...
      the least square term can now be expressed as below with mathematical details in Appendix 1:
    ...
    - Find $$ \boldsymbol{R}^* $$
      ...
      now we try to isolate $$\boldsymbol{R}$$ out of the summation (mathematical details can be found in Appendix 2):
      ...
      Mathematical details about the optimality can be found in Appendix 3.
