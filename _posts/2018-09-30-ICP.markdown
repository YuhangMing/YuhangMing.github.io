...
#### Solutions:
  ...
  - Linear Estimation
    ...
    - Find $$ \boldsymbol{R}^* $$
      ...
      Due to the orthogonality of the rotation matrix, i.e. $$ \boldsymbol{R}^T \boldsymbol{R} = \boldsymbol{I} $$, the first 2 terms irrelavant to $$ \boldsymbol{R} $$. Hence the least square problem becomes:
